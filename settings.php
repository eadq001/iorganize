...
<body>
    ...
    <main class="main-content">
        ...
        <div class="settings-card">
            <h3>Backup & Import</h3>
            <p>Create backups of your calendar events, diary entries, and sticky notes. You can also import previously created backups.</p>
            
            <div class="settings-section">
                <h4>Create Backup</h4>
                <p>Download a backup of all your data as a JSON file.</p>
                <button type="button" class="btn btn-primary" onclick="createBackup()">📥 Create & Download Backup</button>
            </div>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    <label for="backupFile">Select Backup File (JSON)</label>
                    <input type="file" id="backupFile" name="backupFile" accept=".json" required>
                </div>
                <div class="form-group">
                    <label for="importOption">
                        <input type="checkbox" id="importOption" name="importOption">
                        Merge with existing data (unchecked = replace all data)
                    </label>
                </div>
                <button type="button" class="btn btn-primary" onclick="importBackup()">📤 Import Backup</button>
            </div>
            
            <div id="backupMessage" style="display:none; margin-top: 15px;" class="alert"></div>
        </div>
